        ...
        <div class="container px-lg-5">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">As we approach International Women's Day this March, we are excited to announce the
                        BlueSPACE Innovation Hub's upcoming event, <strong><em>"DigitAll: Innovation and technology for
                                Gender Equality,"</em></strong> and we are delighted to extent an invitation to you to
                        be a part of this transformative event.</p>
                    <div class="section-title position-relative mb-4 pb-2">
                ...
                <p class="mb-4">The upcoming BIH International Women's Day
